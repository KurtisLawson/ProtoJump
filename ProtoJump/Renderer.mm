...
@interface Renderer () {
    ...
    GLuint brickVertexArray, ballVertexArray, groundVertexArray, roofVertexArray;   // vertex arrays for brick and ball
    int numBrickVerts, numBallVerts, numGroundVerts, numRoofVerts, steps;
